...
NEVER=(".experts.","indexer","embed_tokens","lm_head",".mlp.gate.",".f_b_proj",".g_b_proj",
       ...
       # KDA fuses q,k,v,b,f_a,g_a into in_proj_qkvbfg_a and loads f_a/g_a as REPLICATED shards with
       # output_size pre-multiplied by tp_size (kda.py:74-80). That path does not line up with packed
       # NVFP4 parameters: g16 loaded every other quantized layer and asserted only here.
