...
DST="/var/tmp/models/keys-glm53-nvfp4-attn2"
NEWDIR="/var/tmp/glm53-vllm-cache/nvfp4attn2"
...
DROP={"*.self_attn.in_proj_qkvbfg_a",
      "*.self_attn.q_proj","*.self_attn.k_proj","*.self_attn.v_proj",
      "*.self_attn.b_proj","*.self_attn.f_a_proj","*.self_attn.g_a_proj",
      "*.self_attn.o_proj","*.self_attn.q_b_proj","*.self_attn.kv_b_proj",
